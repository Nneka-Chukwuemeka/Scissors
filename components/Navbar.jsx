    ...
    <div className=' fixed w-full h-20 shadow-xl z-[100] '>
      ...
      <ul className=' list-none hidden xl:flex  space-x-10 text-xl '>
          ...
          <li>
             ...
             <button>Login</button>
             <button className=' hidden md:block rounded-3xl bg-[#0065FE] text-white py-2 px-3 '>Try for free</button>
             </ul>
             <div
...
<div
   ...
   <Link href='/'>
                <li onClick={() => setNav(false)} className='py-10 text-xl mt-[-2rem]'>
                My URLs
                </li>
              </Link>
              <Link href='/'>
              ...
              <Link href='/'>
               ...
               <button onClick={() => setNav(false)} className=' rounded-3xl bg-[#0065FE] text-white py-3 px-4'>Try for free
