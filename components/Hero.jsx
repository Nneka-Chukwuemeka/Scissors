...
const Hero = () => {
  return (
    <header className="py-[8rem] px-4">
        ...
        <div className="pb-14 max-w-fit mx-auto">
          <div className="rounded-[24px] border-[1px] border-primary min-h-[224px] p-8 w-full max-w-[600px] flex gap-x-5">
